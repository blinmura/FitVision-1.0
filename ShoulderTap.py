...
class ShoulderTap(Exercise):
    ...
    def exercise(self, source):
        ...
        ang1 = 0
        ang2 = 0
        count = int(ProgressManager.load_progress().get("ShoulderTap", 0)) # ← загружаем прогресс
        frames = 0
        ...
        while True:
            ...
            try:
                ...
                if 11 in idx_to_coordinates and 13 in idx_to_coordinates and 15 in idx_to_coordinates:  # left side
                ...
                if 12 in idx_to_coordinates and 14 in idx_to_coordinates and 16 in idx_to_coordinates:  # right side
            ...
            try:
                ...
                if frames > 80:
                    ...
                    if ang2 > 150 and performedRightTap:
                        count += 1
                        performedRightTap = False
                        ProgressManager.save_progress("ShoulderTap", count)
                ...
                ang2 = 180 - ang2
                c2 = (0, 255, 0) if ang2 > 70 else (255, 0, 0)
        ...
        ProgressManager.save_progress("ShoulderTap", count)  # ← сохраняем прогресс при выходе
        pose.close()
